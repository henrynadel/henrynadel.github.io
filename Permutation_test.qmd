...
new_sqft_by_unemployment |>
  ...
  theme_minimal()
```
In this graph we see years with higher construction volumes tend to have lower unemployment, suggesting a potential negative correlation.
...
Still, this permutation study demonstrates how randomization methods can assess relationships between data while avoiding distributional assumptions.
